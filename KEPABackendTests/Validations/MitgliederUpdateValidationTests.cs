...
public class MitgliederUpdateValidationTests
{
    ...
    private MitgliederUpdateValidator MitgliederUpdateValidator { get; } = new MitgliederUpdateValidator();

    [Fact]
    public void Mitglied_Update_Passes_Validation()
    {
        //Arrange
        //var mitgliedUpdate = new MitgliedUpdate(string.Empty, "Test", "Test", dtTestDatum20240101_090000);
        ...
        //Act
        var result = MitgliederUpdateValidator.Validate(mitgliedUpdate);
    ...
    {
        //Arrange
        //var mitgliedUpdate = new MitgliedUpdate("Test", string.Empty, "Test", dtTestDatum20240101_090000);
        var mitgliedUpdate = new MitgliedUpdate
        {
            ID = 1,
            Vorname = "Test",
    ...
    {
        //Arrange
        //var mitgliedUpdate = new MitgliedUpdate("TestTestTestTestTestTestTestTestTestTestTestTestTest", "Test", "Test", dtTestDatum20240101_090000);
        var mitgliedUpdate = new MitgliedUpdate
        {
            ID = 1,
    ...
    {
        //Arrange
        //var mitgliedUpdate = new MitgliedUpdate("Test", "TestTestTestTestTestTestTestTestTestTestTestTestTest", "Test", dtTestDatum20240101_090000);
        var mitgliedUpdate = new MitgliedUpdate
        {
            ID = 1,
            Vorname = "Test",
    ...
    {
        //Arrange
        //var mitgliedUpdate = new MitgliedUpdate("Test", "Test", "Test", DateTime.Now.AddDays(1));
        var mitgliedUpdate = new MitgliedUpdate
        {
            ID = 1,
            Vorname = "Test",
